...
export default {
  ...
  methods: {
    ...
    getsmsOption() {
      ...
      const apiurl = `${_self.$apiroot}${this.$props.urlObject.pubSms}`
      _self.$http({
        url: apiurl,
        method: 'get',
    ...
    getyearOption() {
      let _self = this
      const apiurl = `${_self.$apiroot}${this.$props.urlObject.pubYear}`
      _self.$http({
        url: apiurl,
        method: 'get',
        headers:{'SkyGet':_self.$token}
