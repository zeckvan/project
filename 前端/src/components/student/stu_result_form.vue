    ...
    <div>
        <el-dialog title="作品成果紀錄"
            ...
            <el-form ref="ruleForm" :model="form" :rules="rules" label-width="120px">
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="名稱：" prop="result_name">
                          <el-input v-model="form.result_name" style="width:75%;margin-right:100%;" :readonly="(form.is_sys === '1' || edit_model === 'edit')?true:false"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="日期：" prop="result_date">
                            <el-date-picker :clearable="true" v-model="form.result_date" type="date"
            ...
            data() {
                return {
                            ...
                            rules: {
                                ...
                                result_date: [
                                    { required: true, message: '請輸入日期', trigger: 'change' }
                                ],
                                content: [
