    ...
    <div>
        <el-dialog title="學生諮詢課程填寫"
            ...
            <el-form ref="ruleForm" :model="form" :rules="rules" label-width="120px">
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="諮詢教師：" prop="emp_name">
                            <el-input v-model="form.emp_name" style="width:75%;margin-right:100%;" :readonly="(form.is_sys === '1' || edit_model === 'edit')?true:false"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                ...
                <el-row>
                  <el-form-item label="諮詢內容：" prop="consult_content">
                    <el-input v-model="form.consult_content" type="textarea" rows = 5 :readonly="(form.is_sys === '1' || edit_model === 'edit')?true:false"></el-input>
                  </el-form-item>
                </el-row>
            </el-form>
...
*/
    export default {
            ...
            methods: {
                    ...
                    _self.parameter.std_no = _self.$token
