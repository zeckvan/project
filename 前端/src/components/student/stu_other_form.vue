    ...
    <div>
        <el-dialog title="其它活動紀錄"
            ...
            <el-form ref="ruleForm" :model="form" :rules="rules" label-width="120px">
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="名稱：" prop="other_name">
                          <el-input v-model="form.other_name" style="width:75%;margin-right:100%;" :readonly="(form.is_sys === '1' || edit_model === 'edit')?true:false"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="主辦單位：" prop="unit_name">
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="時數" prop="hours">
                            <el-input v-model="form.hours" style="width:75%;margin-right:100%;" :readonly="(form.is_sys === '1' || edit_model === 'edit')?true:false"></el-input>
                        </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
            ...
            data() {
                ...
                return {
                            ...
                            rules: {
                                ...
                                unit_name: [
                                    { required: true, message: '請輸入主辦單位', trigger: 'change' }
                                ],
                                startdate: [
                                ...
                                hours: [
                                    { type: 'decimal', required: false, trigger: 'blur', validator: validateHours }
                                ],                                 
                            },
                            dialogFormVisible: this.dialog_show,
                            is_readonly :false,
                            method_type:"post",
                            typeid:[{id:"01",name:"職場體驗或參訪"},
                                    {id:"02",name:"職場實習"},
                                    {id:"03",name:"職場工作經驗"},
                                    ],
